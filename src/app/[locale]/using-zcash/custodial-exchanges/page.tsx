...
import { exchangesToVenues, getVenuesFromMarkdown } from "@/lib/venueListings";
...
export async function generateMetadata({
  ...
  return genMetadata({
    ...
    locale,
    alternates: buildAlternatesAllLocales("/using-zcash/custodial-exchanges", locale),
  });
}
