...
export const networkUpgrades: NetworkUpgrade[] = [
  ...
  },
  {
    id: "nu7",
    name: "NU7",
    subtitle: "igrating Trust from Orchard to Ironwood",
    date: "TBD",
    blockHeight: null,
    description:
      "Ironwood is a proposed Zcash network upgrade that introduces a new shielded pool designed to strengthen confidence in the integrity of the shielded ZEC supply. The upgrade would enable a gradual migration from Orchard to Ironwood while preserving Zcash's privacy guarantees and leveraging turnstile accounting to provide stronger evidence that all shielded funds are fully backed.",

    features: [
      "Introduces the Ironwood shielded pool",
      "Gradual migration of funds from Orchard to Ironwood",
      "Preserves shielded transaction privacy",
      "Enhanced supply integrity assurances through turnstile accounting",
      "Prevents new value from entering the legacy Orchard pool",
      "Maintains compatibility with existing shielded wallets and Unified Addresses",
      "Provides stronger evidence against undetected shielded inflation",
    ],
    zips: [],
    privacyLevel: 100,
    privacyLabel: "Next-Generation Shielded Privacy",
    status: "future",
    eraColor: "45 100% 65%",
  },
  // {
