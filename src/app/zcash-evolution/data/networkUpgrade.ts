...
export const networkUpgrades: NetworkUpgrade[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Protected against a potential Orchard double-spend vulnerability",
    ],
    zips: [],
    privacyLevel: 94,
  ...
  },
  {
    id: "nu7",
    name: "NU7 / Ironwood",
    subtitle: "Faster Blocks and Shielded Assets Candidate Era",
    date: "TBD",
    blockHeight: null,
    description:
      "NU7, also referred to as Ironwood in current community planning, is the next planned Zcash network upgrade. Its activation height has not yet been set. Candidate ZIPs include 25-second block spacing, Zcash Shielded Assets, v6 transactions, memo bundles, and network sustainability changes.",
    features: [
    ...
    zips: [
      ...
      { number: 2003, title: "Disallow Adding Value to Sprout" },
    ],
    privacyLevel: 100,
