...
const CardsExplorer = ({ image, name, description, url, ...props }: Props) => {
    ...
    return (
        ...
        <div className='w-4/6 border border-gray-200 rounded-lg shadow dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-transparent hover:cursor-pointer hover:scale-110'>
