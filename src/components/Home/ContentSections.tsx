...
const ContentSections = () => {
  ...
  return (
    <section className="flex space-y-24 flex-col w-full ">
      ...
      <InfoCard
        id="hackathon"
        title={t('sections.hackathon.title') || "Join the Hackathon"}
        description={
          t('sections.hackathon.description') ||
        ...
        links={[
          {
            href: "/hackathon",
            label:
              t('sections.hackathon.mainLink') || "Join the Hackathon",
            primary: true,
          },
        ]}
      />
      <InfoCard
        ...
        description={
          t('sections.zcashMe.description') ||
        ...
        links={[
          {
            href: "https://zcash.me",
            label: t('sections.zcashMe.link') || "Visit Zcash.Me",
            primary: true,
          },
        ]}
      />
      <InfoCard
        ...
        description={
          t('sections.whatIsZcash.description') ||
        ...
        links={[
          {
            ...
            label: t('sections.whatIsZcash.mainLink') || "What is Zcash?",
            primary: true,
          },
          {
            href: "/zcash-tech/zk-snarks",
            label:
              t('sections.whatIsZcash.techLink') || "Zcash Technology",
          },
        ]}
      />
      ...
      <InfoCard
        ...
        title={
          t('sections.globalAmbassadors.title') ||
          "Zcash Global Ambassadors"
        }
        description={
          t('sections.globalAmbassadors.description') ||
        ...
        links={[
          {
            ...
            label:
              t('sections.globalAmbassadors.link') ||
      ...
      <InfoCard
        ...
        links={[
          {
            href: "/newsletter",
            label: t('sections.newsletter.link') || "Subscribe",
            primary: true,
          },
        ]}
      />
        ...
        links={[
          {
            ...
            label: t('sections.free2z.link') || "Free2Z",
            primary: true,
          },
        ]}
      />
      ...
      <InfoCard
        ...
        description={
          t('sections.payWithZcash.description') ||
        ...
        links={[
          {
            ...
            label: t('sections.payWithZcash.mainLink') || "paywithz.cash",
            primary: true,
          },
          {
            href: "https://zechub.wiki/map",
            label: t('sections.payWithZcash.mapLink') || "Flexa",
          },
        ]}
      />
    </section>
