...
export const MetricCard = ({
  ...
  <div
    className={`
      ...
      min-h-[118px] md:min-h-[128px]
    `}
  >
    {/* Purple accent bar - Hidden until hover */}
    <div 
      className="
...
export const MetricCardSkeleton = () => (
  <div className="bg-slate-100 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-xl p-5 md:p-6 shadow animate-pulse min-h-[118px] md:min-h-[128px]">
