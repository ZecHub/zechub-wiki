...
// Desktop nav links
const NavLinks: React.FC<NavLinksProps> = ({ classes = "", closeMenu }) => (
...
// Mobile nav links
const MobileNavLinks: React.FC<MobileNavLinksProps> = ({ classes = "", closeMenu }) => (
