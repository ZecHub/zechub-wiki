...
const WELCOME_STAGE_INTERVAL = 4000; // 4 seconds for welcome stage
const OTHER_STAGES_INTERVAL = 8000; // 8 seconds for other stages
    ...
    <div className="flex flex-col">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mt-2">
          Learn about bounties, grants, and open source opportunities
        </p>
      </motion.header>
