...
const slides = [
  {
    ...
    steps: [
      "Complete privacy protection for your transactions",
      "Shielded addresses hide sender, receiver, and amount",
      "No transaction history visible on public blockchain",
      "Protect your financial privacy from surveillance",
      "Support decentralized, censorship-resistant payments",
    ],
    link: "https://z.cash/",
    linkText: "Learn More About Zcash",
  },
  {
    id: "paywithz",
    title: "Paywithz.cash",
    ...
    steps: [
      "Visit paywithz.cash to find merchants accepting ZEC",
      "Browse by category: services, products, donations",
      "Discover businesses worldwide accepting Zcash",
      "Direct links to merchant payment pages",
      "Support privacy-focused commerce",
    ],
    link: "https://paywithz.cash/",
    linkText: "Visit Paywithz.cash",
  },
  {
    id: "flexa-zashi",
    ...
    steps: [
      ...
      "Access Flexa payment network integration",
      "Pay at thousands of retail locations",
      "Scan QR codes at participating merchants",
      "Instant, private payments with ZEC",
    ],
    link: "https://zashi.cash/",
    linkText: "Download Zashi Wallet",
  },
  {
    id: "nym-coincards",
    ...
    steps: [
      "Nym VPN: Pay for privacy-focused VPN service with ZEC",
      "Coincards: Purchase gift cards using Zcash payments",
      "Both services prioritize user privacy and anonymity",
      "Easy integration with Zcash wallets",
      "Support privacy-first businesses",
    ],
  ...
  {
    id: "accept-payments",
    title: "Accept ZEC Payments",
    icon: Store,
    color: "from-amber-500 to-orange-600",
    steps: [
      "BTCPay Server: Self-hosted payment processor supporting ZEC",
      "Zgo: Merchant solution for accepting Zcash payments",
      "Easy integration with your online store",
      "Receive payments directly to your Zcash wallet",
      "Join the growing network of Zcash-accepting merchants",
    ],
    link: "https://zgo.cash/",
    linkText: "Explore Zgo Payment Processor",
  },
];

export { slides };

interface PayWithZcashContentProps {
  currentSlide: number;
  onSlideChange: (index: number) => void;
  isPlaying: boolean;
}

export const PayWithZcashContent = ({
  currentSlide,
  onSlideChange,
  isPlaying,
}: PayWithZcashContentProps) => {
    ...
    <div className="max-w-5xl mx-auto px-4">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg">
          Discover where and how to use ZEC for private payments
        </p>
      </motion.div>
