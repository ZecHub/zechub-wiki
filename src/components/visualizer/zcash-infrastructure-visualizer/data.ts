...
import { ComponentsMap, Stage } from "./types";
...
export const STAGES: Stage[] = [
  {
    ...
    description:
      "Explore how Zcash's components work together to enable private, decentralized transactions across the entire network stack.",
    highlight: [],
  },
  {
    id: 1,
    ...
    description:
      "Zebra nodes validate every transaction and maintain the complete Zcash blockchain, forming the decentralized backbone that ensures network security and consensus.",
    highlight: ["zebra"],
  },
  {
    id: 2,
    ...
    description:
      "Zakura is a full node implementation for Zcash, with major improvements over existing nodes: faster sync, native block pruning with configurable retention, a zcashd compatibility mode, and an experimental P2P layer built for high-performance block propagation.",
    highlight: ["zakura"],
  },
  {
    id: 3,
...
export const COMPONENTS: ComponentsMap = {
  zebra: {
    name: "Zebra Node",
    description:
      "Full node implementation that validates and stores the complete Zcash blockchain",
    color: "from-yellow-400 via-amber-400 to-yellow-500",
    borderColor: "border-yellow-400/50",
    glowColor:
      "shadow-[0_0_40px_rgba(251,191,36,0.4),0_0_80px_rgba(251,191,36,0.2)]",
    icon: Server,
  ...
  zaino: {
    name: "Zaino Indexer",
    description:
      "Rust-based indexer that processes blockchain data for light clients",
  ...
  lightwalletd: {
    ...
    glowColor:
      "shadow-[0_0_40px_rgba(34,211,238,0.4),0_0_80px_rgba(34,211,238,0.2)]",
    icon: Layers,
    docs: "https://zechub.wiki/developers/quick-start#zebrad",
    layer: 2,
  },
  mobile: {
    ...
    glowColor:
      "shadow-[0_0_30px_rgba(192,132,252,0.4),0_0_60px_rgba(192,132,252,0.2)]",
    icon: Smartphone,
  ...
  desktop: {
    ...
    description:
      "Full-featured desktop applications with advanced privacy controls",
    color: "from-violet-400 via-purple-400 to-violet-500",
    borderColor: "border-violet-400/50",
    glowColor:
      "shadow-[0_0_30px_rgba(167,139,250,0.4),0_0_60px_rgba(167,139,250,0.2)]",
    icon: Monitor,
  ...
  web: {
    ...
    glowColor:
      "shadow-[0_0_30px_rgba(96,165,250,0.4),0_0_60px_rgba(96,165,250,0.2)]",
    icon: Globe,
    docs: "https://zechub.wiki/developers/quick-start",
    layer: 3,
  },
