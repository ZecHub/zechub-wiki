const AnimationHome = () =>  (
    <div className="justify-center items-center flex mx-auto h-30 relative">
        <svg className="path" width="400px" height="200px" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="sine  w-24 bg-yellow-300 rounded-full absolute"></div>
    </div>
)
