...
const SearchBar = ({ openSearch, setOpenSearch }: Props) => {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    results.length > 0 || searchInput != ' ' ? setSearchResults(results) : setSearchResults([])
  };
                      ...
                      <Link key={result.name} href={result.url} onClick={onClose} >
                        ...
                        >
                          <div className="block">
                            ...
                            <div className="w-full text-gray-500 justify-self-auto dark:text-gray-400 text">{result.desc}</div>
                          </div>
