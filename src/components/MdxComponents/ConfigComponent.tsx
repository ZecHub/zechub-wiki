...
const MdxComponents = {
  code: (props: HTMLProps<HTMLElement>): JSX.Element => (
    <code {...props} className="bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-100 px-1.5 py-0.5 rounded text-sm font-mono">
      {props.children}
    </code>
  ),
  Video: (props: React.VideoHTMLAttributes<HTMLVideoElement>) => <video {...props} />,

  // Modern mobile-friendly tables
  ...
  thead: (props: HTMLProps<HTMLTableSectionElement>): JSX.Element => <thead className="bg-slate-100 dark:bg-slate-800" {...props} />,
  tr: (props: HTMLProps<HTMLTableRowElement>): JSX.Element => <tr className="border-b border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-900/50" {...props} />,
  tbody: (props: HTMLProps<HTMLTableSectionElement>): JSX.Element => <tbody {...props} />,
  th: (props: HTMLProps<HTMLTableCellElement>): JSX.Element => <th className="px-6 py-4 text-left font-semibold text-slate-900 dark:text-white" {...props} />,
  td: (props: HTMLProps<HTMLTableCellElement>): JSX.Element => <td className="px-6 py-4 text-slate-700 dark:text-slate-300" {...props} />,

  // Clean image handling (no deprecated layout, no GitHub tree rewrite)
  ...
  blockquote: (props: HTMLProps<HTMLQuoteElement>): JSX.Element => <blockquote className="text-base text-justify my-2 border-l-4 border-slate-300 dark:border-slate-600 pl-4" {...props}>{props.children}</blockquote>,
  ul: (props: HTMLProps<HTMLUListElement>): JSX.Element => <ul {...props} className="list-disc pl-6 space-y-1" />,
  ...
  p: (props: HTMLProps<HTMLParagraphElement>): JSX.Element => <p className="text-base text-left my-4 leading-relaxed" {...props} />,
