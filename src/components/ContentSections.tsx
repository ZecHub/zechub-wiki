    ...
    return (
        <section>
            <div className="flex  space-y-4 flex-col w-full mt-5">
                <div className="flex flex-col md:flex-row  h-screen w-auto bg-yellow-400 rounded-md p-5">
                    <div className="flex items-center justify-center w-2/4">
                        <Image className="" src={'/card-image.webp'} alt="" width={500} height={100} />
                    </div>

                    <div className="flex flex-col w-2/4 items-center justify-center text-white font-bold">
                        <h1 className="text-3xl mb-4">What is Zcash?</h1>
                ...
                <div className="flex flex-col md:flex-row h-screen my-4 w-auto bg-black rounded-md p-5">
                ...
                <div className="flex flex-col md:flex-row h-screen my-4 w-auto bg-cyan-400 rounded-md p-5">
                    <div className="flex justify-center w-2/4">
                        <Image className="" src={'/card-image.webp'} alt="" width={500} height={100} />
                    </div>
                    <div className="flex flex-col w-2/4 items-center justify-center text-white font-bold">
