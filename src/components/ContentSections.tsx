    ...
    <>
      <section>
        <div className='flex space-y-4 flex-col w-full mt-5'>
          ...
          <div
            className='flex flex-col md:flex-row space-y-4 h-96 my-4 w-full border-green-400/50 border-2 rounded-md p-5'
            style={{ height: '30rem' }}
          >
            <div className='flex justify-center items-center w-auto md:w-2/4'>
              <FadeInAnimation>
            ...
            <div className='flex flex-col w-auto md:w-2/4 items-center justify-center'>
              <FadeInAnimation>
                <h1 className='text-3xl mb-4 font-semibold'>Shielded Newsletter</h1>
              </FadeInAnimation>
              <FadeInAnimation>
                <p className='text-center mb-5'>
