...
export const PROTECTED_TRANSLATION_TERMS: ProtectedTranslationTerm[] = [
  ...
  { term: "Paradigm", category: "organization", note: "Investor / VC firm" },
  { term: "a16z", category: "organization", note: "Andreessen Horowitz" },
  { term: "a16z crypto", category: "organization" },
  { term: "Chapter One", category: "organization", note: "Investor / VC firm" },
  { term: "Winklevoss Capital", category: "organization" },
  { term: "Coinbase Ventures", category: "organization" },
  { term: "Cypherpunk Technologies", category: "organization" },

  { term: "Tutorials", category: "service", note: "Section name — keep untranslated" },
