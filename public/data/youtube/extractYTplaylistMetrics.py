...
def main(api_key, playlist_id):
    ...
    video_details = get_all_video_details(youtube, playlist_id)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Fetch view counts for videos in a YouTube playlist.')
    parser.add_argument('--api_key', required=True, help='Your YouTube Data API key')
    parser.add_argument('--playlist_id', required=True, help='The ID of the YouTube playlist')
    args = parser.parse_args()
    main(args.api_key, args.playlist_id)